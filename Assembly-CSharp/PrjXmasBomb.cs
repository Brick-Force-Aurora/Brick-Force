...
public class PrjXmasBomb : Projectile
{
	...
	private Vector3 colPoint = Vector3.zero;
	...
	public void TailUpdate(Vector3 pos)
	{
		if (!(tail == null))
		{
	...
	private void Kaboom()
	{
		...
		if (smoke != null)
		{
			Object.Instantiate((Object)smoke, colPoint, Quaternion.Euler(0f, 0f, 0f));
		}
	...
	private void Update()
	{
		...
		if (!(null != component) || !component.isKinematic)
		{
			...
			{
				colPoint = base.transform.position;
				Kaboom();
			}
