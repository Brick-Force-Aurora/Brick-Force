...
public class aiBomber : MonAI
{
	public override void changeTexture()
	{
		...
		if (component != null)
		{
			...
			{
				((Component)smr).renderer.material.mainTexture = component.texBomberRed;
			}
			else
			{
				((Component)smr).renderer.material.mainTexture = component.texBomberBlue;
			}
		}
	}
}
