...
[Serializable]
public class BndConfig
{
	public Texture2D nonavailable;

	public Rect crdFrame = new Rect(0f, 468f, 250f, 132f);
	...
	private Color clrValue = new Color(0.91f, 0.6f, 0f, 1f);
	...
	public void OnGUI()
	{
		...
		if (room != null && regMap != null)
		{
			...
			LabelUtil.TextOut(crdMode, room.GetString(Room.COLUMN.TYPE), "MiniLabel", clrValue, GlobalVars.txtEmptyColor, TextAnchor.MiddleLeft);
			DoOption(room);
