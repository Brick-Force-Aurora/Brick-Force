...
public class Result4IndividualMatch : MonoBehaviour
{
	...
	private void OnGUI()
	{
		...
		LabelUtil.TextOut(new Vector2(killX, resultY), StringMgr.Instance.Get("KILL") + "/" + StringMgr.Instance.Get("ASSIST") + "/" + StringMgr.Instance.Get("DEATH"), "Label", new Color(1f, 0.66f, 0f, 1f), GlobalVars.txtEmptyColor, TextAnchor.MiddleCenter);
		LabelUtil.TextOut(new Vector2(missionX, resultY), StringMgr.Instance.Get("MISSION"), "Label", new Color(0f, 0.87f, 1f, 1f), GlobalVars.txtEmptyColor, TextAnchor.MiddleCenter);
