...
namespace _Emulator
{
    public class BrickEditPos2Command : ICommand
    {
        public string Description()
        {
            return "Sets the second position of the selection tool";
        }
        ...
        public void Execute(CommandContext context)
        {
            ...
            EditHelper.BrickEditTool.SetPos2(coordinates[0], coordinates[1], coordinates[2]);
        }
    }
}
