...
public class Result4Capture : MonoBehaviour
{
	...
	private Vector2 crdScore = new Vector2(937f, 76f);
	...
	private void DoTotal()
	{
		...
		string text = StringMgr.Instance.Get("SCORE") + "  " + RoomManager.Instance.redScore.ToString() + " : " + RoomManager.Instance.blueScore.ToString();
		LabelUtil.TextOut(crdScore, text, "Label", Color.white, new Color(0f, 0f, 0f, 0f), TextAnchor.MiddleCenter);
	}
	...
	{
		LabelUtil.TextOut(new Vector2(10f, 10f), tooltipMessage, "Label", Color.yellow, new Color(0f, 0f, 0f, 0f), TextAnchor.UpperLeft);
	}
