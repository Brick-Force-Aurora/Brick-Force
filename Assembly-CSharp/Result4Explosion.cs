...
public class Result4Explosion : MonoBehaviour
{
	...
	private Rect crdRedTotal = new Rect(880f, 20f, 54f, 49f);

	private Rect crdBlueTotal = new Rect(940f, 20f, 54f, 49f);

	private Vector2 crdRTK = new Vector2(880f, 16f);

	private Vector2 crdRTD = new Vector2(934f, 72f);

	private Vector2 crdBTK = new Vector2(940f, 16f);

	private Vector2 crdBTD = new Vector2(994f, 72f);

	private Vector2 crdTotalStuff = new Vector2(937f, 9f);

	private Vector2 crdRound = new Vector2(937f, 76f);
	...
	private float GridOut(ResultUnit ru, float y)
	{
		...
		LabelUtil.TextOut(new Vector2(nickX, y), ru.nickname, "Label", Color.white, new Color(0f, 0f, 0f, 0f), TextAnchor.MiddleCenter);
		LabelUtil.TextOut(new Vector2(killX, y), ru.kill.ToString() + "/" + ru.assist.ToString() + "/" + ru.death.ToString(), "Label", new Color(0.83f, 0.49f, 0.29f), new Color(0f, 0f, 0f, 0f), TextAnchor.MiddleCenter);
		LabelUtil.TextOut(new Vector2(missionX, y), ru.mission.ToString(), "Label", new Color(0.83f, 0.49f, 0.29f), new Color(0f, 0f, 0f, 0f), TextAnchor.MiddleCenter);
		LabelUtil.TextOut(new Vector2(scoreX, y), ru.score.ToString(), "Label", new Color(0.83f, 0.49f, 0.29f), new Color(0f, 0f, 0f, 0f), TextAnchor.MiddleCenter);
		LabelUtil.TextOut(new Vector2(xpX, y), ru.xp.ToString(), "Label", Color.white, new Color(0f, 0f, 0f, 0f), TextAnchor.MiddleCenter);
		LabelUtil.TextOut(new Vector2(pointX, y), ru.point.ToString(), "Label", Color.white, new Color(0f, 0f, 0f, 0f), TextAnchor.MiddleCenter);
	...
	private void DoTotal()
	{
		...
		LabelUtil.TextOut(crdTotalStuff, StringMgr.Instance.Get("ALL") + " " + StringMgr.Instance.Get("KILL") + "/" + StringMgr.Instance.Get("DEATH"), "Label", Color.white, new Color(0f, 0f, 0f, 0f), TextAnchor.MiddleCenter);
		LabelUtil.TextOut(crdRTK, redTotalKill.ToString(), "Label", Color.white, new Color(0f, 0f, 0f, 0f), TextAnchor.UpperLeft);
		LabelUtil.TextOut(crdRTD, redTotalDeath.ToString(), "Label", Color.white, new Color(0f, 0f, 0f, 0f), TextAnchor.LowerRight);
		LabelUtil.TextOut(crdBTK, blueTotalKill.ToString(), "Label", Color.white, new Color(0f, 0f, 0f, 0f), TextAnchor.UpperLeft);
		LabelUtil.TextOut(crdBTD, blueTotalDeath.ToString(), "Label", Color.white, new Color(0f, 0f, 0f, 0f), TextAnchor.LowerRight);
		string text = StringMgr.Instance.Get("ROUND") + "  " + RoomManager.Instance.redScore.ToString() + " : " + RoomManager.Instance.blueScore.ToString();
		LabelUtil.TextOut(crdRound, text, "Label", Color.white, new Color(0f, 0f, 0f, 0f), TextAnchor.MiddleCenter);
	}
	...
	private void OnGUI()
	{
		...
		LabelUtil.TextOut(new Vector2(markX, redResultY), StringMgr.Instance.Get("MARK"), "Label", Color.white, new Color(0f, 0f, 0f, 0f), TextAnchor.MiddleCenter);
		LabelUtil.TextOut(new Vector2(badgeX, redResultY), StringMgr.Instance.Get("BADGE"), "Label", Color.white, new Color(0f, 0f, 0f, 0f), TextAnchor.MiddleCenter);
		LabelUtil.TextOut(new Vector2(nickX, redResultY), StringMgr.Instance.Get("CHARACTER"), "Label", Color.white, new Color(0f, 0f, 0f, 0f), TextAnchor.MiddleCenter);
		LabelUtil.TextOut(new Vector2(killX, redResultY), StringMgr.Instance.Get("KILL") + "/" + StringMgr.Instance.Get("ASSIST") + "/" + StringMgr.Instance.Get("DEATH"), "Label", new Color(1f, 0.66f, 0f, 1f), new Color(0f, 0f, 0f, 0f), TextAnchor.MiddleCenter);
		LabelUtil.TextOut(new Vector2(missionX, redResultY), StringMgr.Instance.Get("MISSION"), "Label", new Color(0f, 0.87f, 1f, 1f), new Color(0f, 0f, 0f, 0f), TextAnchor.MiddleCenter);
		LabelUtil.TextOut(new Vector2(scoreX, redResultY), StringMgr.Instance.Get("SCORE"), "Label", new Color(0.8f, 1f, 0.02f, 1f), new Color(0f, 0f, 0f, 0f), TextAnchor.MiddleCenter);
		LabelUtil.TextOut(new Vector2(xpX, redResultY), StringMgr.Instance.Get("XP"), "Label", Color.white, new Color(0f, 0f, 0f, 0f), TextAnchor.MiddleCenter);
		LabelUtil.TextOut(new Vector2(pointX, redResultY), StringMgr.Instance.Get("POINT"), "Label", Color.white, new Color(0f, 0f, 0f, 0f), TextAnchor.MiddleCenter);
		...
		LabelUtil.TextOut(new Vector2(markX, blueResultY), StringMgr.Instance.Get("MARK"), "Label", Color.white, new Color(0f, 0f, 0f, 0f), TextAnchor.MiddleCenter);
		LabelUtil.TextOut(new Vector2(badgeX, blueResultY), StringMgr.Instance.Get("BADGE"), "Label", Color.white, new Color(0f, 0f, 0f, 0f), TextAnchor.MiddleCenter);
		LabelUtil.TextOut(new Vector2(nickX, blueResultY), StringMgr.Instance.Get("CHARACTER"), "Label", Color.white, new Color(0f, 0f, 0f, 0f), TextAnchor.MiddleCenter);
		LabelUtil.TextOut(new Vector2(killX, blueResultY), StringMgr.Instance.Get("KILL") + "/" + StringMgr.Instance.Get("ASSIST") + "/" + StringMgr.Instance.Get("DEATH"), "Label", Color.white, new Color(0f, 0f, 0f, 0f), TextAnchor.MiddleCenter);
		LabelUtil.TextOut(new Vector2(missionX, blueResultY), StringMgr.Instance.Get("MISSION"), "Label", Color.white, new Color(0f, 0f, 0f, 0f), TextAnchor.MiddleCenter);
		LabelUtil.TextOut(new Vector2(scoreX, blueResultY), StringMgr.Instance.Get("SCORE"), "Label", Color.white, new Color(0f, 0f, 0f, 0f), TextAnchor.MiddleCenter);
		LabelUtil.TextOut(new Vector2(xpX, blueResultY), StringMgr.Instance.Get("XP"), "Label", Color.white, new Color(0f, 0f, 0f, 0f), TextAnchor.MiddleCenter);
		LabelUtil.TextOut(new Vector2(pointX, blueResultY), StringMgr.Instance.Get("POINT"), "Label", Color.white, new Color(0f, 0f, 0f, 0f), TextAnchor.MiddleCenter);
		y = blueFirstRowY;
		for (int j = 0; j < RoomManager.Instance.RU.Length; j++)
		{
			if (!RoomManager.Instance.RU[j].red)
	...
	{
		LabelUtil.TextOut(new Vector2(10f, 10f), tooltipMessage, "MiniLabel", Color.yellow, new Color(0f, 0f, 0f, 0f), TextAnchor.UpperLeft);
	}
