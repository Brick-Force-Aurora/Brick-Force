...
public class GdgtXmasBomb : WeaponGadget
{
	...
	public void SelfKaboom(Vector3 pos)
	{
		...
		if (smoke != null)
		{
			Object.Instantiate((Object)smoke, pos, Quaternion.Euler(0f, 0f, 0f));
		}
	}

	public void Kaboom(int index)
	{
		if (dic != null && dic.Count != 0 && dic.ContainsKey(index) && dic[index].projectile != null && dic[index].projectile.transform != null)
		{
			...
			if (smoke != null)
			{
				Object.Instantiate((Object)smoke, position, Quaternion.Euler(0f, 0f, 0f));
			}
